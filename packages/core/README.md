...
[![npm version](https://img.shields.io/npm/v/@sonate/core.svg)](https://www.npmjs.com/package/@sonate/core)
...
- [`@sonate/verify-sdk`](https://www.npmjs.com/package/@sonate/verify-sdk) — Client-side receipt verification (browser + Node.js)
- [`@sonate/schemas`](https://www.npmjs.com/package/@sonate/schemas) — JSON Schema + TypeScript types
- `sonate-receipt` — Minimal SONATE receipt client wrapper
